...
WEBSERVER_ROOT = '/var/www/10ktraits.nunn-lab.org'
...
EMAIL_SUBJECT_PREFIX = '[Pcs %s] ' % ENVIRONMENT.title()
...
# BROKER_URL = 'amqp://pcs_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/pcs_%(ENVIRONMENT)s' % os.environ  # noqa
