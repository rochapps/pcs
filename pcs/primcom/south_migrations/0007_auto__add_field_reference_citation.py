...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reference.citation'
        db.add_column(u'primcom_reference', 'citation',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reference.citation'
        db.delete_column(u'primcom_reference', 'citation')
