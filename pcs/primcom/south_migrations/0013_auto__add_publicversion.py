...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublicVersion'
        db.create_table(u'primcom_publicversion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('version_major', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('version_minor', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('file_tag', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'primcom', ['PublicVersion'])


    def backwards(self, orm):
        # Deleting model 'PublicVersion'
        db.delete_table(u'primcom_publicversion')
