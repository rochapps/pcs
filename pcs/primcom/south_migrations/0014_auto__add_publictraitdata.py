...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublicTraitData'
        db.create_table(u'primcom_publictraitdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('who_entered', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('same_check', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ...
            ('sample_size', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('sample_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('basis', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['primcom.PublicVersion'], null=True)),
        ))
        db.send_create_signal(u'primcom', ['PublicTraitData'])


    def backwards(self, orm):
        # Deleting model 'PublicTraitData'
        db.delete_table(u'primcom_publictraitdata')
    ...
    models = {
        ...
        u'primcom.publictraitdata': {
            'Meta': {'object_name': 'PublicTraitData'},
            ...
            'version': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['primcom.PublicVersion']", 'null': 'True'}),
            'who_entered': ('django.db.models.fields.CharField', [], {'max_length': '3'})
        },
        u'primcom.publicversion': {
            'Meta': {'object_name': 'PublicVersion'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'file_tag': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'version_major': ('django.db.models.fields.SmallIntegerField', [], {}),
            'version_minor': ('django.db.models.fields.SmallIntegerField', [], {})
        },
        u'primcom.reference': {
