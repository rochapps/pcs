...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TraitData.sample_type'
        db.add_column(u'primcom_traitdata', 'sample_type',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TraitData.sample_type'
        db.delete_column(u'primcom_traitdata', 'sample_type')
