...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TraitData.sample_size'
        db.alter_column(u'primcom_traitdata', 'sample_size', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'TraitData.sample_size'
        db.alter_column(u'primcom_traitdata', 'sample_size', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
